...
SRCS = src/minishell.c \
	...
	src/parser/parser.c src/parser/redirections.c src/parser/handle_pipes.c  src/parser/heredoc.c \
	src/parser/get_cmd_paths.c src/parser/parser_utils.c \
	src/executor/buildins.c src/executor/executor.c  src/executor/executor_utils.c \
	src/executor/buildins_utils1.c src/executor/buildins_utils2.c src/executor/pipes.c src/executor/child_process.c \
